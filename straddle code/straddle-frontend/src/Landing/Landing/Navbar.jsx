  ...
  return (
    <div className='text-black flex justify-between mx-auto p-5 h-20  items-center '>
        ...
        <ul className='hidden md:flex font-bold text-base'>
            <a href='/About'><li className='p-1 px-7 transition duration-300 hover:text-[#72e485]  cursor-pointer'>About Us</li></a>
            <a href='/Blog'><li className='p-1 px-7 transition duration-300 hover:text-[#72e485]  cursor-pointer'>Blogs</li></a>
            <a href='/Community'><li className='p-1 px-7 transition duration-300 hover:text-[#72e485]  cursor-pointer'>Community</li></a>
        ...
        <ul className='hidden md:flex font-bold text-base mr-14'>
            ...
            <li className='p-2 px-4 bg-[#D9EAB6] rounded-3xl transition duration-300 hover:text-white  cursor-pointer'>
                <button >
        ...
        <a href='/' className='w-44 font-bold'><img src={logo} alt="main navbar logo"/></a>
            <ul className='pt-10 uppercase h-screen '>
                ...
                <a href='/About'><li className='py-5 px-4 text-2xl hover:text-[#72e485] cursor-pointer'>About Us</li></a>
                <a href='/Blog'><li className='py-5 px-4 text-2xl hover:text-[#72e485] cursor-pointer'>Blog</li></a>
                <a href='/Community'><li className='py-5 px-4 text-2xl hover:text-[#72e485] cursor-pointer'>Community</li></a>
