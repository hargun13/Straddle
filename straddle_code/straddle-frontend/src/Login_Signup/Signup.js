  ...
  return (
    <div style={{backgroundImage: `url(${bag2})`, backgroundSize:'cover'}} className="h-screen w-screen overflow-y-hidden flex items-center justify-between px-10" >
                ...
                <div className="w-[100%] mt-5">
                    ...
                    <div className="mt-8 mb-5" >
                        {/* <Link to="/community"> */}
                            ...
                            variant="contained" className="w-full rounded-full" style={{padding:"10px", backgroundColor:"#51B555"}}>Sign Up
                            </Button>
                        {/* </Link> */}
                    </div>
        ...
        <div className="w-[60%] flex flex-col items-center justify-center h-full">
            ...
            <Flip left><img src={rupee} alt="rupee" className="absolute top-[30%]"/></Flip>
            <div className="flex items-center justify-around w-full">
                <Flip left><img src={rupee} alt="rupee" className="w-20"/></Flip>
                <Flip right><img src={rupee} alt="rupee" className="mt-20 w-20"/></Flip>
            </div>
            <div className="flex items-center justify-around w-full">
                <Flip right><img src={rupee} alt="rupee" className="mt-20 w-20"/></Flip>
                <Flip left><img src={rupee} alt="rupee" className="w-20"/></Flip>
